      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
            <h2 className="text-2xl font-semibold mb-4 text-indigo-400">Create New Content</h2>
            <p className="text-gray-400">Create engaging study materials, quizzes, and interactive lessons.</p>
          </div>
          <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
            <h2 className="text-2xl font-semibold mb-4 text-indigo-400">Resource Library</h2>
            <p className="text-gray-400">Access and manage your teaching resources.</p>
          </div>
        </div>
      </motion.div>
    </div>
