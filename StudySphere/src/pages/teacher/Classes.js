      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
            <h2 className="text-2xl font-semibold mb-4 text-indigo-400">Class Overview</h2>
            <p className="text-gray-400">Manage your classes, track attendance, and monitor student progress.</p>
          </div>
        </div>
      </motion.div>
    </div>
